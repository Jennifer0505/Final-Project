...
#global
clouds <<- list("2018"="real.csv","2017"="his_data_2017.csv","2016"="his_data_2016.csv",
                "2015"="his_data_2015.csv","2014"="his_data_2014.csv",
                "2013"="his_data_2013.csv", "2012"="his_data_2012.csv")
test2 <<- list("2018"=100, "2017"=200)
getTermMatrix <- memoise(function(year){
  ...
  myCorpus = tm_map(myCorpus, removeWords, c("this","so", "will", "can", "why","said",
